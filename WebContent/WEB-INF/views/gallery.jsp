			...
			<div class="tz-gallery">
				<div class="row">
					<div class="col-sm-12 col-md-4 col-lg-4">
						<a class="lightbox"
							href="<%=contextPath%>/images/gallery-img-01.jpg"> <img
							class="img-fluid"
							src="<%=contextPath%>/images/gallery-img-01.jpg"
							alt="Gallery <%=contextPath%>/images">
						</a>
					</div>
					<div class="col-sm-6 col-md-4 col-lg-4">
						<a class="lightbox"
							href="<%=contextPath%>/images/gallery-img-02.jpg"> <img
							class="img-fluid"
					...
					<div class="col-sm-6 col-md-4 col-lg-4">
						<a class="lightbox"
							href="<%=contextPath%>/images/gallery-img-03.jpg"> <img
							class="img-fluid"
					...
					<div class="col-sm-12 col-md-4 col-lg-4">
						<a class="lightbox"
							href="<%=contextPath%>/images/gallery-img-04.jpg"> <img
							class="img-fluid"
					...
					<div class="col-sm-6 col-md-4 col-lg-4">
						<a class="lightbox"
							href="<%=contextPath%>/images/gallery-img-05.jpg"> <img
							class="img-fluid"
					...
					<div class="col-sm-6 col-md-4 col-lg-4">
						<a class="lightbox"
							href="<%=contextPath%>/images/gallery-img-06.jpg"> <img
							class="img-fluid"
