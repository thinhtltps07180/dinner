...
<!-- Pickadate CSS -->
<link rel="stylesheet" href="<%=contextPath%>/css/classic.css">
<link rel="stylesheet" href="<%=contextPath%>/css/classic.date.css">
<link rel="stylesheet" href="<%=contextPath%>/css/classic.time.css">
<!-- Responsive CSS -->
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="col-md-12">
										<div class="form-group">
											<input id="input_date"
												class="datepicker picker__input form-control" name="date"
									...
									<div class="col-md-12">
										<div class="form-group">
											<input id="input_time"
												class="time form-control picker__input" required
								...
								<div class="col-md-12">
									<div class="submit-button text-center">
										<button class="btn btn-common" id="submit" type="submit">Book
											Table</button>
